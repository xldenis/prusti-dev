...
impl Expr {
    ...
    pub fn add(left: Expr, right: Expr) -> Self {
        Expr::BinOp(BinaryOpKind::Add, Box::new(left), Box::new(right), Position::default())
    }

    #[allow(clippy::should_implement_trait)]
    pub fn sub(left: Expr, right: Expr) -> Self {
        Expr::BinOp(BinaryOpKind::Sub, Box::new(left), Box::new(right), Position::default())
    }

    #[allow(clippy::should_implement_trait)]
    pub fn mul(left: Expr, right: Expr) -> Self {
        Expr::BinOp(BinaryOpKind::Mul, Box::new(left), Box::new(right), Position::default())
    }

    #[allow(clippy::should_implement_trait)]
    pub fn div(left: Expr, right: Expr) -> Self {
        Expr::BinOp(BinaryOpKind::Div, Box::new(left), Box::new(right), Position::default())
    }

    pub fn modulo(left: Expr, right: Expr) -> Self {
        Expr::BinOp(BinaryOpKind::Mod, Box::new(left), Box::new(right), Position::default())
    }
    ...
    pub fn and(left: Expr, right: Expr) -> Self {
        Expr::BinOp(BinaryOpKind::And, Box::new(left), Box::new(right), Position::default())
    }

    pub fn or(left: Expr, right: Expr) -> Self {
        Expr::BinOp(BinaryOpKind::Or, Box::new(left), Box::new(right), Position::default())
    }
    ...
    pub fn ite(guard: Expr, left: Expr, right: Expr) -> Self {
        Expr::Cond(Box::new(guard), Box::new(left), Box::new(right), Position::default())
    }
    ...
    pub fn wrap_in_unfolding(arg: Expr, body: Expr) -> Expr {
        ...
        let pos = body.pos();
        Expr::Unfolding(type_name, vec![arg], Box::new(body), PermAmount::Read, None, pos)
    }
    ...
    pub fn addr_of(self) -> Self {
        ...
        Expr::AddrOf(Box::new(self), Type::TypedRef(type_name), Position::default())
    }
